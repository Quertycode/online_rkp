...
import { getCurrentUser, getLastCourse } from '../../utils/userStore'
...
export default function Navigation() {
  ...
  const lastCourse = user ? getLastCourse(user.username) : null
  const courseLink = lastCourse ? `/courses/${lastCourse}` : '/courses'
